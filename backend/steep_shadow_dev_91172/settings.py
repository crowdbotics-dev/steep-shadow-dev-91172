"""
Django settings for steep_shadow_dev_91172 project.
...
ROOT_URLCONF = 'steep_shadow_dev_91172.urls'
...
WSGI_APPLICATION = 'steep_shadow_dev_91172.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "steep_shadow_dev_91172 API",
    "DESCRIPTION": "API documentation for steep_shadow_dev_91172 App",
    "VERSION": "v1",
}
